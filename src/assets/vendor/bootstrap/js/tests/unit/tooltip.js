$(function () {
  ...
  QUnit.test('should use title attribute for tooltip label', function (assert) {
    assert.expect(2)
    var done = assert.async()
  ...
  QUnit.test('should not reload the tooltip on subsequent mouseenter events', function (assert) {
    ...
    var $tooltip = $('<span id="tt-outer" rel="tooltip" data-trigger="hover" data-placement="top">some label</span>')
      .appendTo('#qunit-fixture')
  ...
  QUnit.test('should do nothing when an attempt is made to hide an uninitialized tooltip', function (assert) {
    ...
    var $tooltip = $('<span data-toggle="tooltip" title="some tip">some label</span>')
      .appendTo('#qunit-fixture')
                          ...
                          '<div class="modal-dialog" role="document">' +
                            '<div class="modal-content">' +
                              '<div class="modal-body">' +
                                '<a id="tooltipTest" href="#" data-toggle="tooltip" title="Some tooltip label!">Tooltip</a>' +
                              '</div>' +
                            '</div>' +
                          '</div>' +
                        '</div>'
